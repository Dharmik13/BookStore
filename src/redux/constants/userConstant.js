...
export const USER_APPLY_BOOK_REQUEST = "USER_APPLY_BOOK_REQUEST";
export const USER_APPLY_BOOK_SUCCESS = "USER_APPLY_BOOK_SUCCESS";
export const USER_APPLY_BOOK_FAIL = "USER_APPLY_BOOK_FAIL";
export const USER_APPLY_BOOK_RESET = "USER_APPLY_BOOK_RESET";
